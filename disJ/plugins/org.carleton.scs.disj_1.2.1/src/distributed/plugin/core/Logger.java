...
public class Logger extends LogIO {
	
	public enum logTag{ 
		NODE_STATE, NODE_SEND, NODE_INIT, NODE_RECV, NODE_DIE, EDGE_MSG, 
		EDGE_LOST, AGENT_STATE, AGENT_DIE, AGENT_LEAVE, AGENT_ARRIVE,
		AGENT_READ_TO_BOARD, AGENT_WRITE_TO_BOARD, AGENT_DELETE_FROM_BOARD,
		AGENT_DROP_TOKEN, AGENT_PICK_TOKEN, AGENT_AWAKE, AGENT_SLEEP,
		AGENT_NOTIFIED,AGENT_INIT, STATE_FIELD, MODEL_MSG_PASS,  
		MODEL_AGENT_TOKEN, MODEL_AGENT_BOARD, AGENT_LIST
	}
	
	public Logger (String graphId, URL dirUrl, TimeGenerator timeGen){
		super(graphId, dirUrl, timeGen);
	}
