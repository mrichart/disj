...
public class Graph implements Serializable {
	...
	private short globalDelaySeed = 1; // it's usufull for synchronize delay and random
    ...
    public void addColor(Short state, RGB color) {
        this.stateColors.put(state, color);
        //System.out.println("Add color state: " + state);
    }
    ...
    public void removeColor(Short state) {
        ...
        //System.out.println("Remove color state: " + state);
    }
    ...
    public Iterator getStateColors() {
        return this.stateColors.keySet().iterator();
    }
