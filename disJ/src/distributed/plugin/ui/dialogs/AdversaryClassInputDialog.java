...
public class AdversaryClassInputDialog extends Dialog {
	...
	public AdversaryClassInputDialog(Shell parentShell) {
		super(parentShell);
		this.value = null;
	}
	...
	protected void configureShell(Shell newShell) {
		newShell.setText("Set Distributed Model Adversary");
	...
	protected Control createDialogArea(Composite parent) {
		...
		this.className.setText("Fully Qualified Adversary Java Class Name");
